...
$string['modulename'] = 'logla';
$string['modulenameplural'] = 'loglas';
$string['modulename_help'] = 'Use o modulo do logla para... | O modulo do logla module permite...';
$string['logla:addinstance'] = 'Adcione uma nova atividade do logla';
$string['logla:submit'] = 'Submeta o logla';
$string['logla:view'] = 'Veja logla';
$string['loglafieldset'] = 'Configurações das avaliações Metacognitivas';
$string['loglaname'] = 'Nome do logla';
$string['loglaname_help'] = 'Este é o conteúdo da dica de ferramenta de ajuda associada ao campo loglaname. A sintaxe de Markdown é suportada.';
$string['logla'] = 'logla';
$string['pluginadministration'] = 'Administração do logla';
$string['pluginname'] = 'logla';

// Strings from mod_form
$string['PreMetacognition'] = 'Pré-Metacognição';
$string['PreFeedback'] = 'Pré-Feedback';
$string['PosMetacognition'] = 'Pós-Metacognição';
$string['PosFeedback'] = 'Pós-Feedback';
