...
$string ['modulename_help'] = 'Use el módulo del logla para ... | El módulo del logla module permite ... ';
$string ['logla: addinstance'] = 'Adición una nueva actividad del logla';
$string ['logla: submit'] = 'Someta el logla';
$string ['logla: view'] = 'Ver logla';
$string ['loglafieldset'] = 'Configuración de las evaluaciones metacognitivas';
$string ['loglaname'] = 'Nombre de logla';
$string ['loglaname_help'] = 'Este es el contenido de la sugerencia de la herramienta de ayuda asociada al campo loglaname. Se admite la sintaxis de Markdown. ';
$string ['logla'] = 'logla';
$string ['pluginadministration'] = 'Administración del logla';
