...
$string['modulename_help'] = 'Use the logla module for... | The logla module allows...';
$string['logla:addinstance'] = 'Add a new logla';
$string['logla:submit'] = 'Submit logla';
$string['logla:view'] = 'View logla';
$string['loglafieldset'] = 'Metacognitive Evaluation Settings';
$string['loglaname'] = 'logla name';
$string['loglaname_help'] = 'This is the content of the help tooltip associated with the loglaname field. Markdown syntax is supported.';
$string['logla'] = 'logla';
